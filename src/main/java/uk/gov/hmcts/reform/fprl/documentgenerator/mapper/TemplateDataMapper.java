...
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.CASE_DETAILS_STATEMENT_CLARIFICATION_VALUE;
...
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.CLIAM_COSTS_FROM;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.CLIAM_COSTS_FROM_CORESP;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.CLIAM_COSTS_FROM_RESP;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.CLIAM_COSTS_FROM_RESP_CORESP;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.COURT_CONTACT_KEY;
...
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.CO_RESPONDENT_WISH_TO_NAME;
...
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.DN_COURT_CONTACT_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.FREE_TEXT_ORDER_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_CASE_DETAILS_STATEMENT_CLARIFICATION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_FREE_TEXT_ORDER_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_INSUFFICIENT_DETAILS_REJECTION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_JURISDICTION_CLARIFICATION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_MARRIAGE_CERT_CLARIFICATION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_MARRIAGE_CERT_TRANSLATION_CLARIFICATION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_NO_CRITERIA_REJECTION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_NO_JURISDICTION_REJECTION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_ONLY_FREE_TEXT_ORDER_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.HAS_PREVIOUS_PROCEEDINGS_CLARIFICATION_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.INSUFFICIENT_DETAILS_REJECTION_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.ISSUE_DATE_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.JURISDICTION_CLARIFICATION_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.LETTER_DATE_FORMAT;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.MARRIAGE_CERT_CLARIFICATION_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.MARRIAGE_CERT_TRANSLATION_CLARIFICATION_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.NO_CRITERIA_REJECTION_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.NO_JURISDICTION_REJECTION_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.PREVIOUS_PROCEEDINGS_CLARIFICATION_VALUE;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.REFUSAL_CLARIFICATION_REASONS;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.REFUSAL_REJECTION_REASONS;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.SERVICE_CENTRE_COURT_ADDRESS;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.SERVICE_CENTRE_COURT_CONTACT_DETAILS;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.SERVICE_CENTRE_COURT_NAME;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.SERVICE_COURT_NAME_KEY;
import static uk.gov.hmcts.reform.fprl.documentgenerator.domain.TemplateConstants.SOLICITOR_IS_NAMED_CO_RESPONDENT;
