...
public class TemplatesConfigurationTest {
    ...
    @Autowired
    private uk.gov.hmcts.reform.fprl.documentgenerator.config.TemplatesConfiguration classUnderTest;
    ...
    public static void setUp() {
        expectedTemplateConfigs = Sets.newHashSet(
            new ImmutableTriple<>(DUMMY_DOCUMENT,
                                  DUMMY_DOCUMENT_TEMPLATE_ID,
                                  DOCMOSIS_TYPE
            )
        );
    }
